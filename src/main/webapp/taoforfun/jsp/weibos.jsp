...
%>		
		<div class="message">
		<ul>
			<li><img class="head" src="<%=path%>/taoforfun/img/user.png" alt="userPNG" style="width:100px;height:100px;"/></li>
			<li>UserName: <%=weibo.getAdder() %></li>
			<li>date: <%=weibo.getTime() %></li>
			<li>content: <%=weibo.getContent() %></li>
